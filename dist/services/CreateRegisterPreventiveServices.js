...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        var equipament_id = _a.equipament_id, technician_id = _a.technician_id, jobs = _a.jobs, isCorrective = _a.isCorrective;
        return __awaiter(this, void 0, void 0, function () {
            var preventiveRepository, preventive;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        preventiveRepository = typeorm_1.getRepository(Preventives_1.default);
                        preventive = preventiveRepository.create({
                            equipament_id: equipament_id,
                            technician_id: technician_id,
                            jobs: jobs,
                            isCorrective: isCorrective,
                        });
                        return [4 /*yield*/, preventiveRepository.save(preventive)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, preventive];
                }
            });
        });
    };
