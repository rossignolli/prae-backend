...
jobsRouter.get('/report', async (request, response) => {
    try {
        const equipamentsRepository = getRepository(Job);
        ...
        equipaments.forEach((equipament, i) => {
            ...
            rows.push({
                text: `R$ ${equipament.supply.pricePerJob}`,
                alignment: 'left',
                margin: [0, 5, 0, 5],
            });
            rows.push({
        ...
        const docDef: TDocumentDefinitions = {
            ...
            content: [
                ...
                {
                    text: `Relatório de Procedimentos  `,
                    alignment: 'center',
                    style: 'header',
                    margin: [0, 20, 0, 0],
                },
                ...
                {
                    text: 'Listagem geral de procedimentos cadastrados.',
                    alignment: 'center',
                    margin: [0, 10, 0, 20],
                },
                {
